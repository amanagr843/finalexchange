...
all.onmessage = evt => {
  ...
  const isMobile = width <= 900;
    ...
    return(<>
       ...
       <h2 style={{color:"whitesmoke",paddingBottom:"1rem",paddingTop:"1rem"}}>Live Prices -</h2>
         <div className="row">
         <div class="col-lg-4 col-md-4 col-sm-6 col-6 " style={{paddingBottom:"1.2rem"}}>
          ...
          <div className="col-lg-4 col-md-4 col-sm-6  col-6" style={{paddingBottom:"1.2rem"}}>
            <h4 style={{fontSize:"1.2rem",color:"whitesmoke"}}>EAGLE/INR </h4>
             <h4><span style={{color:btc_per > 0 ? "green" : "red",fontSize:"1.2rem"}}>{} </span></h4>
             <h4 style={{color:'gold',fontSize:"1.2rem"}}>₹ 5.00</h4>
            <h4 style={{fontSize:"1.2rem",color:"whitesmoke"}} >$ {(5.00/conversion).toFixed(2)}</h4>
          </div>
          <div className="col-lg-4 col-md-4 col-sm-6  col-6" style={{paddingBottom:"1.2rem"}}>
            <h4 style={{fontSize:"1.2rem",color:"whitesmoke"}}>EAGLEANT/INR </h4>
             <h4><span style={{color:btc_per > 0 ? "green" : "red",fontSize:"1.2rem"}}>{} </span></h4>
             <h4 style={{color:'gold',fontSize:"1.2rem"}}>₹ 1.00</h4>
            <h4 style={{fontSize:"1.2rem",color:"whitesmoke"}} >$ {(1.00/conversion).toFixed(5)}</h4>
          </div>
         </div>
       </div>
       </section> 
