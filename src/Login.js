...
<div className="mask"style={{overflow:"hidden"}} >
...

  {
   ...
   <a style={{fontSize:"1.1rem",color:"white",fontWeight:"lighter",filter:invert(1),marginLeft:"0.7rem",marginTop:"-7rem",cursor:"pointer",position:"fixed"}}  onClick={()=>{
        localStorage.removeItem("land")
        window.location.href="/"
    }}> <img src={back} style={{height:"3rem",filter:invert(1)}}/></a>
      ...
      <button className="btn btn-primary btn-block btn-large" type="submit" style={{marginBottom:"2rem"}} onClick={()=>{
        ...
        axios({
                    ...
                    if(res.data.success){
                        ...
                        setVisible(false)
                        setvisible1(true)
                        swal("Success","Please enter the verification code sent to your registered email address","success")
                    }
